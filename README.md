...
<div id="foto" align="center">
  ...
  - Освоил вычисления в блокноте **Jupiter**, очень удобный инструмент кстати <https://github.com/SergeyBorozdin/python_jupyter_notebook>
  ...
  - Создание дашборда с отчетами PowerBI по результатам работы обслуживающей комании сложнотехничаского оборудования в крупной торговой сети розничных магазинов. Отражает график обслуживания и отставание, состояние оборудования, рекомендации по ремонту, топ востребованых запчастей, затраты на закупку и тд <https://github.com/SergeyBorozdin/reportPaternoster>
  - калькулятор инвестиций. ранее был реализован на екселях
