...
<div id="badges" align="center">
  ...
  - Командный проект **Math.h**. В команде из четырех тиммейдов реализовали библиотеку для работы со математическими формулами на языке Си <https://github.com/SergeyBorozdin/school21-math>
  - 
  -
